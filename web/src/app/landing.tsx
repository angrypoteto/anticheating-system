    ...
    <main className="bg-white dark:bg-gray-950">
      ...
      <section className="mx-auto max-w-6xl px-6 pb-20 pt-12 sm:pt-20">
        <div className="max-w-3xl">
          <p className="text-sm font-medium uppercase tracking-widest text-accent dark:text-[#5FBDB6]">
            Web-based anti-cheating system
          </p>
          <h1 className="mt-4 font-serif text-4xl font-semibold leading-tight tracking-tight text-gray-900 sm:text-5xl dark:text-gray-50">
